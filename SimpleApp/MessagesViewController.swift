...
class MessagesViewController: JSQMessagesViewController {
    ...
    func setupFirebase() {
        ...
        messagesRef = Firebase(url: "https://wanna-help.firebaseio.com")
        
        // *** STEP 4: RECEIVE MESSAGES FROM FIREBASE (limited to latest 25 messages)
        messagesRef.queryLimitedToFirst(25).observeEventType(FEventType.ChildAdded, withBlock: { (snapshot) -> Void in
